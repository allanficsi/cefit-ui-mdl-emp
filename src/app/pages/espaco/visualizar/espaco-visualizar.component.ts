...
@Component({
  ...
  templateUrl: './espaco-visualizar.component.html',
  styleUrls: ['./espaco-visualizar.component.css']
})
export class EspacoVisualizarComponent extends AptareCrudController<Espaco, {new(): Espaco}>{
