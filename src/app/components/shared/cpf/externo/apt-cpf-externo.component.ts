...
@Component({
  selector: 'apt-cpf-externo',
  templateUrl: './apt-cpf-externo.component.html',
  styleUrls: ['./apt-cpf-externo.component.css'],
  providers: [ CPF_CONTROL_VALUE_ACCESSOR ]
})
export class AptCpfExternoComponent implements ControlValueAccessor, OnInit {
